...
class ShippingMethodListResponse implements \JsonSerializable
{
    public ?array $data;
    ...
    public static function fromArray(array $data): self
    {
        ...
        $model->data = isset($data['data'])
            ? array_map(fn($item) => ShippingMethodResponse::fromArray($item), $data['data'])
            : null;
    ...
    {
        return [
            'data' => $this->data ? array_map(fn($item) => $item->toArray(), $this->data) : null,
