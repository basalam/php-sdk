...
/**
 * PlanSubscriptionListResource model.
 */
class PlanSubscriptionListResource implements \JsonSerializable
{
    private ?array $data;
    ...
    {
        return new self(
            isset($data['data']) ? array_map(fn($item) => PlanSubscriptionResource::fromArray($item), $data['data']) : null,
